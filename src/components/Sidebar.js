...
//         ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0 sm:w-64 sm:static sm:h-auto sm:flex sm:flex-col`}
//     >
//       <button
...
//           <NavLink
//             to="/"
//             className="flex items-center cursor-pointer hover:bg-white hover:text-blue-900 p-2 rounded"
//           >
...
//             <span className="ml-3 hidden sm:inline text-lg">تعديل الإعلان</span>
//           </NavLink>
//         </li>
//         <li>
//           <NavLink
